    ...
    try {
        ...
        Object.keys(categories).forEach((cat, i) => {
            ...
            categories[cat].forEach(item => {
                ...
                if (item.page_id === 'rogue') link = '1job_rogue.html'; 
                if (item.page_id === 'wizard') link = '1job_wizard.html';
                if (item.page_id === 'priest') link = '1job_priest.html';
                if (item.page_id === 'samurai') link = '1job_samurai.html';
                if (item.page_id === 'blacksmith') link = '1job_blacksmith.html';
                if (item.page_id === 'chef') link = '1job_chef.html';
                if (item.page_id === 'pharmacist') link = '1job_pharmacist.html';
                ...
                if (item.page_id === 'meister') link = '2job_meister.html';
                ...
                if (item.page_id === 'seedlancer') link = '2job_seedlancer.html';
                if (item.page_id === 'fencer') link = '2job_fencer.html';
                if (item.page_id === 'battlesmith') link = '2job_battlesmith.html';
                if (item.page_id === 'bishop') link = '2job_bishop.html';
                if (item.page_id === 'berserk') link = '2job_berserk.html';
